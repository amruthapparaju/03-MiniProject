package com.miniproject.three.generator;
...
public class AdharGenerator implements IdentifierGenerator {
	private static final String sql_seq = "select adhar_no_seq.nextval from dual";
